...
class GameConfig:
    ...
    # Nombres de los archivos (El programa buscará variaciones .png y .jpg automáticamente)
    IMAGENES = [
        "papa.png", 
        "zanahoria.png", 
        "brocoli.png", 
...
class MathDragGameLevel2:
    ...
    def _create_gui(self):
        ...
        tk.Label(self.content_frame, text="¡ESCRÍBELO TÚ!", font=self.font_title, 
    ...
    def game_win(self):
        ...
        tk.Label(win, text="¡Completaste la ecuación! 🥕", font=("Arial", 14), bg="white", fg="#555").pack(pady=10)
    ...
    # --- CARGA DE IMÁGENES (SIN BOLAS VERDES) ---
    ...
    def crear_imagen_verdura(self, nombre_archivo, cantidad):
        ...
        # Forzamos grilla mínima de 2x2 para que los items sean chicos
        rows_visuales = 2
        ...
        for i in range(cantidad):
            ...
            if item_img:
                ...
                # Escribe el nombre del archivo en rojo para saber qué falta.
                try:
